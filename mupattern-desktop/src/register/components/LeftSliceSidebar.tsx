      ...
      {hasWorkspace && (
        <>
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">Choose position and stack indices.</p>
          </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(e) => {
                    void handlePositionChange(e.target.value);
                  }}
                >
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(e) => {
                    void handleChannelChange(Number(e.target.value));
                  }}
                >
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(e) => {
                    void handleTimeChange(Number(e.target.value));
                  }}
                >
                ...
                <Button
                  ...
                  disabled={
                    activeWorkspace.times.indexOf(activeWorkspace.selectedTime) >=
                    activeWorkspace.times.length - 1
                  }
                  title="Next time"
                >
                  <ChevronRight className="size-4" />
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  onChange={(e) => {
                    void handleZChange(Number(e.target.value));
                  }}
                >
